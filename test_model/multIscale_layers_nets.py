...
#output width=((W-F+2*P )/S)+1
    ...
    def forward(self, x):
        ...
        #local_bz,num,_,local_l = side_out_full.size() 
...
#output width=((W-F+2*P )/S)+1
    ...
    def forward(self, x):
        ...
        local_bz,num,_,local_l = side_out1.size() 
        side_out1 = side_out_low.view(-1,num,local_l).squeeze(1)# squess before fully connected

        local_bz,num,_,local_l = side_out2.size() 
        side_out2 = side_out_low.view(-1,num,local_l).squeeze(1)# squess before fully connected

        local_bz,num,_,local_l = side_out3.size() 
        side_out3 = side_out_low.view(-1,num,local_l).squeeze(1)# squess before fully connected
         
        local_bz,num,_,local_l = side_out2l.size() 
        side_out2l = side_out_low.view(-1,num,local_l).squeeze(1)# squess before fully connected

        local_bz,num,_,local_l = side_out3l.size() 
        side_out3l = side_out_low.view(-1,num,local_l).squeeze(1)# squess before fully connected
        #out
