	...
	-working dir(e.g. "E:deeplearning" for my windows, "/media/icube/DATA1/deeplearning/" for my linux)/
		...
		--working dir/dataset/ (everything about data)
			...
			---working dir/dataset/for IVUS (store prepared training data, online generated training data,test data)
				...
				----Root/dataset/for IVUS/train/ (training data)
					-----Root/dataset/for IVUS/train/img/
						-----Root/dataset/for IVUS/train/img/sub1/(.jpg or .tif etc...)
						-----Root/dataset/for IVUS/train/img/sub2/(.jpg or .tif etc...)
						...
					-----Root/dataset/for IVUS/train/label/  
						-----Root/dataset/for IVUS/train/label/sub1/ ( encoding transformed pkl  )
						-----Root/dataset/for IVUS/train/label/sub1/ ( encoding transformed pkl  )
						---
			...
			---working dir/dataset/annotate/( prepare for autoannotation)
				...
				----Root/dataset/pic/(.jpg .tif files )
				----Root/dataset/label_generate/( .json files generated by nets)
