...
# This net s output ulti layers ( here is 4 layers)
class _multiscal__layer__(nn.Module):
#output width=((W-F+2*P )/S)+1

    def __init__(self):
        super(_multiscal__layer__, self).__init__()
...
class _multiscal__attenuation__(nn.Module):
#output width=((W-F+2*P )/S)+1

    def __init__(self):
        super(_multiscal__attenuation__, self).__init__()
