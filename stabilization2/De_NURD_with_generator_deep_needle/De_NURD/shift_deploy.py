...
class Shift_Predict(object):
    def __init__(self ):
        ...
        dir_netD = os.path.join(current_file, '../../DeepLearningModel/shift/netD_epoch_2.pth')
        dir_netD = '/home/icube/OCT_projects/Contour_project/out/DeepLearningModel/shift/netD_epoch_2.pth'
