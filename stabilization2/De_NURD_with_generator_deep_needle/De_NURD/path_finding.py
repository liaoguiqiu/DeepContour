...
dir_netD =os.path.join(current_file,'../../DeepLearningModel/deep_path/netD_epoch_5.pth')
dir_netD =   '/home/icube/OCT_projects/Contour_project/out/DeepLearningModel/deep_path/netD_epoch_5.pth'
