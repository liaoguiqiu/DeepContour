...
class Pair2Path(object):
    def __init__(self ):
        ...
        pth_save_dir = os.path.join(current_file, '../../DeepLearningModel/pair2path/cGANG_epoch_4.pth')
        pth_save_dir = '/home/icube/OCT_projects/Contour_project/out/DeepLearningModel/pair2path/cGANG_epoch_4.pth'
